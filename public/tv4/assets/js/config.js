...
FF.paths={index:'/',shop:'/products',product:'/products/tao-xanh',cart:'/cart',checkout:'/checkout',orders:'/orders','order-detail':'/orders/NSX-20260912-0001',login:'/login',register:'/register',account:'/profile',addresses:'/addresses',wishlist:'/wishlist',review:'/reviews','ui-states':'/ui-states'};
