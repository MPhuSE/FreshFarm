...
@section('page-header')
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('admin.products.index') }}" class="inline-flex items-center gap-2 rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-slate-800">
            &larr; Quay lại
        </a>
    </div>
@endsection
